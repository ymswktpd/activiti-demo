...
/**
 * @description: 工作流网关(排他网关)
 * @author: xijie
 * @dte: 2022/4/11
 */
@RunWith(SpringRunner.class)
@SpringBootTest
public class ActivitiExclusiveDemo {
 ...
 */
    ...
    public void test01() {
        Deployment deployment = repositoryService.createDeployment()
                .addClasspathResource("processes/evection-exclusive.bpmn20.xml")
                .name("出差申请单-排他网关").deploy();
